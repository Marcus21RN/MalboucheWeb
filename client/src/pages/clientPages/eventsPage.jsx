...
export default function EventsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#202020] text-gray-500 font-['combo']">
      {/* === BANNER PRINCIPAL === */}
        ...
        <div className="bg-[#20202081] absolute inset-0 z-10 flex flex-col justify-center items-start pl-40 h-full px-4">
          <div className="mb-8">
            ...
            <h1 className="font-['combo'] font-semibold text-6xl text-white drop-shadow-md">
              <span className="block text-lg font-semibold font-[combo] text-[#ffffff]">MALBOUCHE</span>
              UPCOMING EVENTS
...
<section
  ref={containerRef}
  className="text-white font-['combo'] py-8 px-6"
>
  <div className="flex flex-col items-end w-full space-y-4">
    <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-end gap-4 w-full sm:w-auto">
      ...
      <AnimatePresence>
        {mostrarFiltros && (
          <motion.select
            ...
            className="w-full sm:w-auto px-3 py-1.5 rounded border border-gray-400 bg-[#8c8c8c1a] text-white focus:outline-none focus:ring-2 focus:ring-[#b2b2b2b2] shadow"
          >
      ...
      <div className="px-4 py-10 max-w-7xl mx-auto space-y-6">
        {eventosFiltrados.map((evento) => {
          ...
          return (
            <div
              key={evento._id}
              className="border-b border-[#202020] overflow-hidden group hover:shadow-[0_0_20px_#8c8c8c] transition duration-300"
              onClick={() =>
                setEventoExpandido(
            ...
            >
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 gap-4">
                ...
                <div className="flex items-center gap-6 min-w-[200px]">
                  <div className="text-center border-r border-[#8c8c8c] pr-6">
                    <div className="text-5xl font-bold text-[#ffffff] leading-none">{day}</div>
                  ...
                  <div className="flex flex-col">
                    <p className="text-2xl md:text-3xl font-bold text-[#ffffff] uppercase group-hover:text-[#cacaca] transition">
                      {evento.nombre}
                    </p>
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-sm text-[#8c8c8c]">{evento.horaInicio}</span>
                      {evento.horaFinal && (
                        <>
                          <span className="text-xs text-gray-500">-</span>
                          <span className="text-sm text-[#8c8c8c]">{evento.horaFinal}</span>
                        </>
                      )}
                    </div>
                  </div>
          ...
          <div className="relative bg-gradient-to-br from-[#202020] via-[#4f4f4f] to-[#c6c6c69f] text-white font-['combo'] p-8 rounded-lg max-w-2xl w-full shadow-2xl border-2 border-[#8c8c8c] animate-fadeIn">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="md:w-1/3 mt-2">
                ...
                <div>
                  <p className="mt-4 text-md font-['combo'] text-gray-300 text-justify">
                    {eventoSeleccionado.descripcion}
                  </p>
                </div>
              </div>
              <div className="md:w-2/3">
                <h2 className="text-3xl font-bold font-['combo'] mb-4 text-[#fff] text-center uppercase">
      ...
      <div className="w-full bg-gradient-to-b from-[#202020] to-[#4f4f4f] py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center">
          <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8">
            {/* Texto */}
            <div className="text-center md:text-left max-w-2xl">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-['combo'] text-white uppercase tracking-wider leading-tight">
                DON'T MISS OUT THE FUN. <span className="text-[#c7c7c7] block md:inline">BOOK NOW.</span>
              </h1>
            </div>
            {/* Botón */}
            <button 
